...
cat "${filepath}/${fileprefix}1.extract.csv" > "${filepath}/${fileprefix}full.csv"
...
/usr/local/hadoop/bin/hadoop fs -put "${filepath}/${fileprefix}full.csv" /coursera/input_short3
