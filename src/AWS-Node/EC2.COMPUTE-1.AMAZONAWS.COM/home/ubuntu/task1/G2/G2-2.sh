...
/usr/local/hadoop/bin/yarn jar AirportAirportDeparturePerformance.jar AirportAirportDeparturePerformance -libjars `echo /usr/share/cassandra/*.jar | sed 's/ /,/g'` -libjars `echo /usr/share/cassandra/lib/*.jar | sed 's/ /,/g'` /coursera/input_short /coursera/G2-Q1-output
