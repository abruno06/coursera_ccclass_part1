...
public class PopularAirport extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
		...
		jobCount.setJarByClass(PopularAirport.class);
        ...
        jobTop.setJarByClass(PopularAirport.class);
    	...
    	public static class CountAirportMap extends Mapper<Object, Text, Text, IntWritable> {
    		...
    		public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
    			...
    			//'FlightDate','DayOfWeek','TailNum','FlightNum','DepTime','ArrTime','UniqueCarrier','Origin','Dest','DepDelay','ArrDelay','DepDelayMinutes','ArrDelayMinutes'
    						...
    						if (!fields[7].isEmpty())//if Origin is empty for any reason then line is rejected
    						{
    						...
    						if (!fields[8].isEmpty())//if Destination is empty for any reason then line is rejected
    						{
    						context.write(new Text(fields[8]), new IntWritable(1));
    						}
    						else
    						{
    							//System.out.print("Data\n");
