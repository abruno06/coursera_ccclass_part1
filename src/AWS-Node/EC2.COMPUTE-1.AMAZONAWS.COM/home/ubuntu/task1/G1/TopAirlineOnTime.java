    	...
    	public static class ComputeFlyDelayMap extends Mapper<Object, Text, Text, FloatWritable> {
    		...
    		public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
    			...
    			String[] fields = value.toString().split((","));
    						...
    						if (!fields[6].isEmpty() && !fields[11].isEmpty() )//if UniCarrier and Delay are empty for any reason then line is rejected
    						{
    						context.write(new Text(fields[6]), new FloatWritable(Float.parseFloat(fields[11])));
    						}else
    						{
